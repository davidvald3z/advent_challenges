...
-83879"
        ...
        @boxes = "mvgowxqubnhaefjslkjlrptzyi
...
cvgowxqulnhaefmslrjdrntzyi"
    ...
    def boxes_checksum
        ...
        boxes.split("\n").each do |b|
            ...
            h.each do |k ,v|
                if v == 2 and !two_taken
                    two_counter += 1
                    two_taken = true
                elsif v == 3 and !three_taken
                    three_counter += 1
                    three_taken = true
                end
            end
    ...
    def boxes_diff_one_char
        ...
        boxes.split("\n").each do |b|
            ...
            boxes.split("\n").each do |b_aux|
                b.split("").each_with_index do |letter, index|
                    if letter != b_aux[index]
                        diff_counter += 1
                        diff_pos = index
                    end
                end

                break if diff_counter == 1
                diff_counter = 0
            end
            if diff_counter == 1
                value = b
        ...
        if diff_counter == 1
            puts value
            value[0..(diff_pos - 1)] + value[(diff_pos + 1)..]
        else
            ""
        end
    end
